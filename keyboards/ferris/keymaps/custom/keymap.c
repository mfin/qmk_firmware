...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(
    ...
    A_HYP, S_CTL, D_GUI, F_ALT, KC_G,            KC_H, J_ALT, K_GUI,   L_CTL,  SC_HYPR,
  ...
  [_NAV] = LAYOUT(
    ...
    KC_HYPR,  KC_LCTL, KC_LGUI, KC_LALT, KC_TRNS,         KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_TRNS,
  ...
  [_SYM] = LAYOUT(
    ...
    KC_GRV,  KC_LBRC, KC_LCBR, KC_LPRN, KC_QUOT,         KC_TRNS, KC_LALT, KC_LGUI, KC_LCTL, KC_HYPR,
  ...
  [_NUM] = LAYOUT(
    ...
    KC_HYPR, KC_LCTL, KC_LGUI, KC_LALT, KC_TRNS,         KC_TRNS, KC_4, KC_5, KC_6, KC_TRNS,
